...
import { assessSharedCheckEvidence, createConservativeRetainedReusePolicy, sharedEvidenceCaveat } from '../clients/typescript/dist/assurance.js';
...
test('conservative shared-evidence helper requires multiple signal classes', () => {
  assert.equal(assessSharedCheckEvidence(strong).eligible, true);
  assert.equal(createConservativeRetainedReusePolicy()(strong, {v:1}, {v:1}), true);
