...
test('SeenRelay exposes a self-hosted Claude Code marketplace', () => {
  ...
  assert.equal(publicFacts.install.claude_plugin_install_command, 'claude plugin install seenrelay@seenrelay-plugins');
});
