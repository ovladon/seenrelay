...
JavaScript/TypeScript 0.2.1 is local-first. Python 0.2.1 and the classic JavaScript/TypeScript client remain shadow-first. Provider-specific adapters are optional.
