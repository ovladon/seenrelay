...
export function dataPracticesDescriptor(origin: string) {
  ...
  return {
    ...
    legacy_storage: 'Rows written before hash-only persistence may retain previously submitted values until separately removed under retention or maintenance controls.',
