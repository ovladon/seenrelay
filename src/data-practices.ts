...
export function dataPracticesDescriptor(origin: string) {
  ...
  return {
    ...
    legacy_storage: 'Legacy submitted values have been removed from active Production storage. Database constraints prevent raw submitted values from being persisted in the legacy value columns.',
