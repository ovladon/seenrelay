...
export function trustDescriptor(origin: string) {
  return {
    ...
    verification: {
      ...
      release_model: 'Pull request -> CI/security analysis -> isolated Preview Release Gate -> main -> Production.',
...
<section class="section decision"><div class="section-head"><div><div class="eyebrow">RELEASE BOUNDARY</div><h2>Production should be reproducible from reviewed evidence.</h2></div><p>${esc(trust.verification.release_model)}</p></div><div class="proof-grid"><article><b>Source and CI</b><span>GitHub is the public source of record. CI runs type checks, security/product guardrails, dependency audit and tests.</span></article><article><b>Isolated Preview</b><span>The release gate exercises the exact PR head against its Vercel Preview before promotion.</span></article><article><b>Live commit</b><span><code>/healthz</code> exposes the Production deployment SHA so an integrator can compare what is live with the public repository.</span></article><article><b>Security reporting</b><span>Security-sensitive reports use the private vulnerability path described in <a href="https://github.com/ovladon/seenrelay/blob/main/SECURITY.md">SECURITY.md</a>, not public exploit disclosure.</span></article></div></section>
