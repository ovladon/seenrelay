...
<div><div class="eyebrow">PUBLIC INSTALL · CLIENT v${esc(f.install.client_version)}</div><h2>Two commands. Zero required base runtime dependencies.</h2><p>No SeenRelay account or API key is required. A third-party client, directory, gateway, or assistant may require its own account to use that third-party service; that is not a SeenRelay access requirement. The canonical direct MCP endpoint is <code>https://seenrelay.com/mcp</code>. The public npm and PyPI packages were clean-install verified from their registries before this claim was published.</p></div>
...
export function siteFooterHtml(): string {
  ...
  return `<footer><span>© ${copyrightYears} SeenRelay. All rights reserved.</span><span>Recent observations, not universal truth.</span><span><a href="/privacy">Privacy</a> · <a href="/data-practices">Data practices</a> · <a href="https://github.com/ovladon/seenrelay/issues/new">Questions / pilot</a> · <a href="https://github.com/ovladon/seenrelay">GitHub</a> · <a href="https://github.com/ovladon/seenrelay/blob/main/LICENSE">Core &amp; Claude plugin: SeenRelay License</a> · <a href="https://github.com/ovladon/seenrelay/blob/main/clients/LICENSE">Client libraries: MIT License</a> · CHECK · OBSERVE</span></footer>`;
}
