---
name: seenrelay
description: Find repeated expensive read-only checks in AI agent workloads and measure whether reuse is worthwhile. Start in shadow mode; preserve authoritative and stronger native controls.
